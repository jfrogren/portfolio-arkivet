...
I pointed out that the results indicated 10% lower awareness of the possibility to be actively involved in research even though the p-value was not sufficiently low to indicated any significance. However, SI rightly pointed out that only write in the results the significant or not.
