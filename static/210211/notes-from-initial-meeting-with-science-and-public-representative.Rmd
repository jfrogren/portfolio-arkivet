...
Next, I described my PhD project and what part I perceived that Bostadsförsöket and the particular study I planned to conduct within it had.  explained that my doctoral project is about studying different methods or forms for conducting collaborative research or involving people who are not researchers in the research process in research on aging and health. SI filled in and gave a little more context to my story.

MB explained that citizen research has historically been about the possibility of large datasets, but also in the process to let people get a better idea of what research is. Then we went in to discuss the study structure and focus.
